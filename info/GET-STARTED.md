...
- Install the [OSS CAD Suite](https://github.com/YosysHQ/oss-cad-suite-build/releases) build tool.
...
- **Flash**: Enabling this will load the bitstream to the flash memory which will survive power-cycles. Uploading into flash takes more time than uploading into SRAM (default)
...
I may not be great in providing the best steps. Feel free to suggest a better version of this page.